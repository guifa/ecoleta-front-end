...
const RegisterPoint = () => {
    ...
    function handleMapClick(event: LeafletMouseEvent) {
        const mapLocation = event.latlng;
    ...
    function handleInputChangey(event: ChangeEvent<HTMLInputElement>) {
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <div className="field">
                        ...
                        <input type="text" name="name" id="name" onChange={handleInputChangey}/>
                    </div>

                    <div className="field-group">
                        <div className="field">
                            <label htmlFor="email">E-mail</label>
                            <input type="email" name="email" id="email" onChange={handleInputChangey}/>
                        </div>
                        <div className="field">
                            <label htmlFor="whatsapp">Whatsapp</label>
                            <input type="text" name="whatsapp" id="whatsapp" onChange={handleInputChangey}/>
                        </div>
                    </div>
                </fieldset>
